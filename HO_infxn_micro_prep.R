...
# Set paths
project_path <- "/data/tide/projects/ho_infxn_ml/input_data/20250217/"
setwd(file.path(project_path))
...
# Pre-processed micro data without organism categories
micro.raw <- data.table::fread(paste0(project_path, "AllMGB_micro_20150525-20250201.csv"))
...
write_csv(micro.raw, file = paste0(project_path, "micro_org_cat_raw_v2024050201.csv"))
# micro.raw <- data.table::fread(paste0(project_path, "micro_org_cat_raw_v20250201.csv"))

# Add EDW PatientIDs
mrns <- read_csv("EDW_MRN_map_20240713.csv") %>%
