...
#### IMPORT ####
clr <- read_csv(file = "/data/tide/projects/ho_infxn_ml/results/model_results/20241105/clr_coefficients.csv")
clrnew<- read_csv(file = "/data/tide/projects/ho_infxn_ml/results/model_results/20241207/clr_coefficients_removed_prior_pathogen.csv")
table1 <- read_csv(file = "/data/tide/projects/ho_infxn_ml/clean_data/20241207/Table1_Baseline_cohort_characteristics.csv")
sample.size <- read_csv(file = "/data/tide/projects/ho_infxn_ml/clean_data/20241207/sample_sizes_20241207.csv")
clean.data <- read_csv(file = "/data/tide/projects/ho_infxn_ml/clean_data/20241210/age_filtered_final_dataset_for_models_20241210.csv")
